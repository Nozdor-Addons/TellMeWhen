...
L["GROUPSETTINGS"] = "Настройки группы"
...
L["ICONALPHAPANEL_ALPHA"] = "Доступно/присутствует"
L["ICONALPHAPANEL_ALPHA_DESC"] = "Прозрачность иконки когда способность доступна/присутствует"
L["ICONALPHAPANEL_CNDTALPHA"] = "Условие не выполнено"
L["ICONALPHAPANEL_CNDTALPHA_DESC"] = "Прозрачность иконки когда её условие не выполнено"
L["ICONALPHAPANEL_DURATIONALPHA"] = "Неверный срок действия"
L["ICONALPHAPANEL_DURATIONALPHA_DESC"] = "Прозрачность иконки когда её требования срока действия не выполнены"
...
L["ICONALPHAPANEL_STACKALPHA"] = "Неверное суммирование"
L["ICONALPHAPANEL_STACKALPHA_DESC"] = "Установка прозрачносит иконки когда её требования суммирования не выполнены"
L["ICONALPHAPANEL_UNALPHA"] = "Недоступно/отсутствует"
L["ICONALPHAPANEL_UNALPHA_DESC"] = "Прозрачность иконки когда способность недоступна/отсутствует"
...
L["ICONMENU_DURATIONANDCD"] = "Срок действия > восстановление"
...
L["ICONMENU_EDITCONDITION"] = "|cFFFF5959Редактировать|r условие"
...
L["ICONMENU_ICONS"] = "Редактировать иконки"
...
L["UIPANEL_SUBTEXT1"] = "Эти парамерты позволяют изменять количество, расположение и поведение уведомляющих иконок."
